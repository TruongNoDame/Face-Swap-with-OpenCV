...
#init a video writer
result = cv2.VideoWriter(os.path.join(project_path,'outputs',f'{video_name}.avi'), 
                         cv2.VideoWriter_fourcc(*'MJPG'),
                         10, size)

SOURCE_PATH = os.path.join(project_path,'images',image_name)
#init a dlib face detector
frontal_face_detector = dlib.get_frontal_face_detector()
frontal_face_predictor = dlib.shape_predictor("models/shape_predictor_68_face_landmarks.dat")
